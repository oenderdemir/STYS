...
builder.Services.AddScoped<STYS.Kurumlar.Services.ITenantBrandingService, STYS.Kurumlar.Services.TenantBrandingService>();
...
builder.Services.AddScoped<IRezervasyonCariKartResolver, RezervasyonCariKartResolver>();
builder.Services.AddScoped<IRezervasyonOdemeMuhasebeService, RezervasyonOdemeMuhasebeService>();
builder.Services.AddScoped<IRezervasyonGelirTahakkukService, RezervasyonGelirTahakkukService>();
...
builder.Services.AddScoped<IGunlukGirisCikisRaporService, GunlukGirisCikisRaporService>();
builder.Services.AddScoped<IGunlukGirisCikisRaporExcelService, GunlukGirisCikisRaporExcelService>();
builder.Services.AddScoped<IOdaMusaitlikRaporService, OdaMusaitlikRaporService>();
builder.Services.AddScoped<IOdaMusaitlikRaporExcelService, OdaMusaitlikRaporExcelService>();
builder.Services.AddScoped<IOdaTipiDolulukRaporService, OdaTipiDolulukRaporService>();
builder.Services.AddScoped<IOdaTipiDolulukRaporExcelService, OdaTipiDolulukRaporExcelService>();
builder.Services.AddScoped<IOrtalamaKonaklamaSuresiRaporService, OrtalamaKonaklamaSuresiRaporService>();
builder.Services.AddScoped<IOrtalamaKonaklamaSuresiRaporExcelService, OrtalamaKonaklamaSuresiRaporExcelService>();
builder.Services.AddScoped<IRezervasyonDurumDagilimiRaporService, RezervasyonDurumDagilimiRaporService>();
...
builder.Services.AddScoped<IKantinSatisIadeService, KantinSatisIadeService>();
...
builder.Services.AddScoped<IKonaklamaVergisiHesapEslemeService, KonaklamaVergisiHesapEslemeService>();
...
builder.Services.AddScoped<IStokCikisStrategy, DogrudanDepoCikisStrategy>();
builder.Services.AddScoped<IStokCikisStrategyResolver, StokCikisStrategyResolver>();
builder.Services.AddScoped<IStokCikisService, StokCikisService>();
builder.Services.AddScoped<ISarfFisiService, SarfFisiService>();
builder.Services.AddScoped<ISarfTuketimRaporService, SarfTuketimRaporService>();
builder.Services.AddScoped<ISarfTuketimRaporExcelService, SarfTuketimRaporExcelService>();
...
builder.Services.AddScoped<IRezervasyonKonaklamaVergiPolitikasi, RezervasyonKonaklamaVergiPolitikasi>();
