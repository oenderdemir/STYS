...
export class AppConfigurator {
    ...
    onPresetChange(event: any) {
        ...
        const themeUpdate = $t().preset(preset).preset(this.getPresetExt());
        (surfacePalette ? themeUpdate.surfacePalette(surfacePalette) : themeUpdate).use({ useDefaultOptions: true });
    }
