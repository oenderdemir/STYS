...
public interface IStokMaliyetPolitikasiService
{
    ...
    Task<List<FifoBaslangicStoguSatirDto>> GetFifoBaslangicStoguAsync(int tesisId, int maliYil, CancellationToken cancellationToken = default);
    Task<List<FifoBaslangicStoguSatirDto>> CreateFifoBaslangicStoguAsync(CreateFifoBaslangicStoguRequest request, CancellationToken cancellationToken = default);
