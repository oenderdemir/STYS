...
[Migration("20260521211000_AddKdvIstisnaTanimlariMenu")]
public partial class AddKdvIstisnaTanimlariMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            -- KDV Istisna Tanimlari MenuItem
            ...
            BEGIN
                ...
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@MenuItemId, N'KDV Istisna Tanımları', N'pi pi-percentage', N'muhasebe/kdv-istisna-tanimlari', @MuhasebeRootId, 18, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'KDV Istisna Tanımları',
            ...
            -- MenuItemRoles: Muhasebe root ve KDV Istisna Tanimlari icin Menu rolu atamasi
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            """
            -- Sadece KDV Istisna Tanimlari MenuItem ve MenuItemRoles kayitlarini temizle.
            DELETE mir
            FROM [TODBase].[MenuItemRoles] mir
            INNER JOIN [TODBase].[MenuItems] mi ON mi.[Id] = mir.[MenuItemId]
            WHERE mi.[Route] = N'muhasebe/kdv-istisna-tanimlari';

            DELETE FROM [TODBase].[MenuItems]
            WHERE [Route] = N'muhasebe/kdv-istisna-tanimlari';
            """);
    }
}
