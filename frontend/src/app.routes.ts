...
import { SarfRaporlariPage } from './app/pages/muhasebe/sarf-raporlari/sarf-raporlari';
...
import { KantinSatisPage } from './app/pages/kantin-yonetimi/kantin-satis';
...
export const appRoutes: Routes = [
    ...
    { path: 'musteri-menu/:restoranId', component: MusteriMenuPage, data: { breadcrumb: ['Musteri Menusu'] } },
    {
        ...
        children: [
            ...
            { path: 'kantin-satis', component: KantinSatisPage, data: { breadcrumb: ['Kantin Yönetimi', 'Hızlı Satış'] } },
            ...
            { path: 'muhasebe/stok-talepleri', component: StokTalepleriPage, data: { breadcrumb: ['Stok & Depo Yönetimi', 'Stok Talepleri'] } },
            ...
            { path: 'muhasebe/sarf-raporlari', component: SarfRaporlariPage, data: { breadcrumb: ['Stok & Depo Yönetimi', 'Sarf / Tüketim Raporları'] } },
            ...
            { path: 'pos-yonetimi', component: PosYonetimiComponent, data: { breadcrumb: ['Sistem', 'POS Yonetimi'] } },
