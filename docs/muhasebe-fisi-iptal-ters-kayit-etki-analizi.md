...
## Faz 88C-B Notu
- Ticari belge iptali backend akışı ayrıca eklendi.
- Muhasebe fişi ters kayıtla iptal edilirken ticari belge stok/cari etkisi de iptal ediliyor.
- Kapalı/kısmi kapalı cari hareket varsa iptal engeli korunuyor.
