...
export const appRoutes: Routes = [
    ...
    { path: 'musteri-menu/:restoranId', component: MusteriMenuPage, data: { breadcrumb: ['Musteri Menusu'] } },
    {
        ...
        children: [
            ...
            { path: 'muhasebe/satis-belgeleri', component: SatisBelgeleriComponent, data: { breadcrumb: ['Muhasebe', 'Satış Belgeleri'], belgeModu: 'satis' } },
            { path: 'muhasebe/alis-belgeleri', component: SatisBelgeleriComponent, data: { breadcrumb: ['Muhasebe', 'Alış Belgeleri'], belgeModu: 'alis' } },
