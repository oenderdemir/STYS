...
{
    public partial class FixAgentYonetimiMenuSeed : Migration
    {
...
-- Find parent menu: prefer 'Sistem', fallback to 'Ana Menu'
...
IF NOT EXISTS (SELECT 1 FROM [TODBase].[MenuItems] WHERE [Label] = N'Agent Yonetimi')
    INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [QueryParams], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
    VALUES (@AgentMenuItem, N'Agent Yonetimi', N'fa-solid fa-robot', N'agent-yonetimi', NULL, @ParentMenuId, 99, 0, @Now, @Now);
