...
public class EBelgeOutboxLeaseTransitionIntegrationTests : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        musteriKart.Ad = "LeaseTransition";
    ...
    private static ISatisBelgesiService CreateService(StysAppDbContext dbContext)
    {
        ...
        return new SatisBelgesiService(
            ...
            // testleri (lease transition mekaniği) UBL feature flag semantiğini DEĞİL, EBelgeKaydi/
            // snapshot/outbox'ın KOŞULSUZ oluştuğunu varsayar; `Enabled=true` bu ÖNCEKİ davranışı
            // KORUR.
