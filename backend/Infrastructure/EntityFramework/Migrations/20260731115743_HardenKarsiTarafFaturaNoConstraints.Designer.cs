...
namespace STYS.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20260731115743_HardenKarsiTarafFaturaNoConstraints")]
    partial class HardenKarsiTarafFaturaNoConstraints
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("SatisBelgeleri", "muhasebe", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_SatisBelgeleri_KarsiTarafFaturaNo_Format", "[KarsiTarafFaturaNo] IS NULL OR (DATALENGTH([KarsiTarafFaturaNo]) > 0 AND DATALENGTH([KarsiTarafFaturaNo]) = DATALENGTH(LTRIM(RTRIM([KarsiTarafFaturaNo]))) AND [KarsiTarafFaturaNo] COLLATE Latin1_General_BIN2 NOT LIKE '%[' + CHAR(1) + '-' + CHAR(31) + ']%')");
                        });
                });
