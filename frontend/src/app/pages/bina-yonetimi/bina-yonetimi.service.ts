...
export class BinaYonetimiService {
    ...
    getBinalarPaged(pageNumber: number, pageSize: number, query: string, tesisId: number | null, sortBy: string, sortDir: SortDirection): Observable<PagedResponseDto<BinaDto>> {
