...
[Migration("20260526000000_AddSatisBelgeleriMenu")]
public partial class AddSatisBelgeleriMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            BEGIN
                ...
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@MenuItemId, N'Satış Belgeleri', N'pi pi-file', N'muhasebe/satis-belgeleri', @MuhasebeRootId, 12, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'Satış Belgeleri',
                    [Icon] = N'pi pi-file',
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            WHERE mi.[Route] = N'muhasebe/satis-belgeleri';

            DELETE FROM [TODBase].[MenuItems]
            WHERE [Route] = N'muhasebe/satis-belgeleri';
            """);
    }
}
