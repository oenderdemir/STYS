...
public sealed class AlisFaturasiMuhasebeFisStratejisi : ISatisBelgesiMuhasebeFisStratejisi
{
        ...
        CancellationToken cancellationToken)
    {
                     ...
                     .OrderBy(x => x.SiraNo))
        {
            ...
            // tutarlar satırın kendi stok/gider hesabına (maliyetin bir parçası olarak) eklenir,
            // böylece fişin Alacak (GenelToplam, artık bu vergileri de içeriyor) = Borç dengesi korunur.
