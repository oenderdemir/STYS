...
[Migration("20260702090000_AddOdaDolulukRaporuPermissionsAndMenu")]
public partial class AddOdaDolulukRaporuPermissionsAndMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            -- Permission rolleri: OdaDolulukRaporuYonetimi.Menu ve .View
            ...
            INSERT INTO @RequiredRoles ([Domain], [Name]) VALUES
                (N'OdaDolulukRaporuYonetimi', N'Menu'),
                (N'OdaDolulukRaporuYonetimi', N'View');
            ...
            DECLARE @MenuRoleId uniqueidentifier = (
                ...
                WHERE [Domain] = N'OdaDolulukRaporuYonetimi' AND [Name] = N'Menu'
            );
            DECLARE @ViewRoleId uniqueidentifier = (
                SELECT TOP (1) [Id] FROM [TODBase].[Roles]
                WHERE [Domain] = N'OdaDolulukRaporuYonetimi' AND [Name] = N'View'
            );
            ...
            -- Grup menü item'a OdaDolulukRaporuYonetimi.Menu rolünü bağla (görünürlük için)
            IF NOT EXISTS (
            ...
            -- Aylik Oda Plani menu item
            DECLARE @OdaDolulukMenuItemId uniqueidentifier;
            SELECT TOP (1) @OdaDolulukMenuItemId = [Id]
            FROM [TODBase].[MenuItems]
            WHERE [Route] = N'raporlar/oda-doluluk-aylik' AND [IsDeleted] = 0;

            IF @OdaDolulukMenuItemId IS NULL
            BEGIN
                SET @OdaDolulukMenuItemId = NEWID();
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [QueryParams], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@OdaDolulukMenuItemId, N'Aylik Oda Plani', N'pi pi-table', N'raporlar/oda-doluluk-aylik', NULL, @RaporlarMenuGrupId, 1, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'Aylik Oda Plani',
                    [Icon] = N'pi pi-table',
                    ...
                    [DeletedAt] = NULL,
                    [UpdatedAt] = @Now
                WHERE [Id] = @OdaDolulukMenuItemId;
            END;

            -- Menü görünürlük rolü: OdaDolulukRaporuYonetimi.Menu
            IF NOT EXISTS (
                SELECT 1 FROM [TODBase].[MenuItemRoles]
                WHERE [MenuItemId] = @OdaDolulukMenuItemId AND [RoleId] = @MenuRoleId AND [IsDeleted] = 0
            )
                INSERT INTO [TODBase].[MenuItemRoles] ([Id], [MenuItemId], [RoleId], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (NEWID(), @OdaDolulukMenuItemId, @MenuRoleId, 0, @Now, @Now);
            """);
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            SET [IsDeleted] = 1, [UpdatedAt] = SYSUTCDATETIME()
            WHERE [Domain] = N'OdaDolulukRaporuYonetimi' AND [IsDeleted] = 0;
            """);
    }
}
