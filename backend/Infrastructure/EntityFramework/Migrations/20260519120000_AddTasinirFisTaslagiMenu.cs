...
[Migration("20260519120000_AddTasinirFisTaslagiMenu")]
public partial class AddTasinirFisTaslagiMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            -- MuhasebeFisYonetimi rolleri (varsa al, yoksa olustur)
            ...
            BEGIN
                ...
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@MenuItemId, N'Taşınır Fiş Taslağı', N'pi pi-file-plus', N'muhasebe/tasinir-fis-taslagi', @MuhasebeRootId, 13, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'Taşınır Fiş Taslağı',
                    [Icon] = N'pi pi-file-plus',
            ...
            -- MenuItemRoles: Muhasebe root ve Tasinir Fis Taslagi icin Menu rolu atamasi
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            """
            -- Sadece Tasinir Fis Taslagi MenuItem ve MenuItemRoles kayitlarini temizle.
            ...
            WHERE mi.[Route] = N'muhasebe/tasinir-fis-taslagi';

            DELETE FROM [TODBase].[MenuItems]
            WHERE [Route] = N'muhasebe/tasinir-fis-taslagi';
            """);
    }
}
