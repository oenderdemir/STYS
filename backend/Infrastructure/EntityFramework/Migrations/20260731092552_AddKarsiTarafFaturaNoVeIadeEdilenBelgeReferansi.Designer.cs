...
namespace STYS.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20260731092552_AddKarsiTarafFaturaNoVeIadeEdilenBelgeReferansi")]
    partial class AddKarsiTarafFaturaNoVeIadeEdilenBelgeReferansi
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("SatisBelgeleri", "muhasebe", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_SatisBelgeleri_KarsiTarafFaturaNo_Format", "[KarsiTarafFaturaNo] IS NULL OR (LEN([KarsiTarafFaturaNo]) > 0 AND [KarsiTarafFaturaNo] = LTRIM(RTRIM([KarsiTarafFaturaNo])) AND [KarsiTarafFaturaNo] COLLATE Latin1_General_BIN2 NOT LIKE '%[' + CHAR(1) + '-' + CHAR(31) + ']%')");
                        });
                });
