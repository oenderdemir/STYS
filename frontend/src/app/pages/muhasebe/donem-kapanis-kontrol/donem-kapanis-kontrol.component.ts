...
import { DonemKapanisKontrolFilterModel, DonemKapanisKontrolModel, DonemKapanisKontrolMaddeModel, createDefaultKapanisFilter } from '../models/donem-kapanis-kontrol.model';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, RouterModule, ButtonModule, CardModule, ConfirmDialogModule, ProgressSpinnerModule, SelectModule, TableModule, TagModule, ToastModule, MuhasebeTesisSecimDialogComponent, MuhasebeTesisContextBarComponent],
