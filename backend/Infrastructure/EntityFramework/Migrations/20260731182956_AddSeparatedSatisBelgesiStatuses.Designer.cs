...
namespace STYS.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20260731182956_AddSeparatedSatisBelgesiStatuses")]
    partial class AddSeparatedSatisBelgesiStatuses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("STYS.Muhasebe.SatisBelgeleri.Entities.SatisBelgesi", b =>
                {
                    ...
                    b.ToTable("SatisBelgeleri", "muhasebe", t =>
                        {
                            t.HasCheckConstraint("CK_SatisBelgeleri_FaturalamaDurumu", "[FaturalamaDurumu] IS NULL OR [FaturalamaDurumu] IN (1, 2, 3, 4, 5, 6)");
                            ...
                            t.HasCheckConstraint("CK_SatisBelgeleri_MuhasebeDurumu", "[MuhasebeDurumu] IS NULL OR [MuhasebeDurumu] IN (1, 2, 3, 4, 5)");

                            t.HasCheckConstraint("CK_SatisBelgeleri_TicariDurum", "[TicariDurum] IS NULL OR [TicariDurum] IN (1, 2, 3)");
                        });
                });
