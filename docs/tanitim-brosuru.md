...
Sistem, sadece oda dolu mu bos mu sorusuna bakmaz. Paylasimli oda, yatak bazli planlama, segmentli konaklama, ariza nedeniyle oda degisimi ve gelmeyen misafir etkisi gibi gercek hayattaki durumlari da dikkate alir.
...
Rezervasyon degisiklik gecmisi, odeme hareketleri, konaklayan plani, oda degisimi ve islem bazli audit kayitlari sayesinde yonetim ve denetim surecleri desteklenir.
...
Bu dokuman istenirse su formatlara da donusturulebilir:

- yonetici ozeti (1 sayfalik)
- PDF satis brosuru
- kurumsal sunum deck'i
- demo toplantisi icin ozellik akis dokumani
