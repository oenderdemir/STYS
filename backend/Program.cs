...
builder.Services.AddScoped<IRestoranMasaRepository, RestoranMasaRepository>();
builder.Services.AddScoped<IRestoranMenuKategoriRepository, RestoranMenuKategoriRepository>();
builder.Services.AddScoped<IRestoranMenuUrunRepository, RestoranMenuUrunRepository>();
builder.Services.AddScoped<IRestoranSiparisRepository, RestoranSiparisRepository>();
builder.Services.AddScoped<IRestoranOdemeRepository, RestoranOdemeRepository>();
...
builder.Services.AddScoped<ICariKartRepository, CariKartRepository>();
builder.Services.AddScoped<ICariHareketRepository, CariHareketRepository>();
builder.Services.AddScoped<IKasaHareketRepository, KasaHareketRepository>();
builder.Services.AddScoped<IBankaHareketRepository, BankaHareketRepository>();
builder.Services.AddScoped<ITahsilatOdemeBelgesiRepository, TahsilatOdemeBelgesiRepository>();
builder.Services.AddScoped<ITasinirKodRepository, TasinirKodRepository>();
builder.Services.AddScoped<ITasinirKartRepository, TasinirKartRepository>();
...
builder.Services.AddScoped<ICariKartService, CariKartService>();
builder.Services.AddScoped<ICariHareketService, CariHareketService>();
builder.Services.AddScoped<IKasaHareketService, KasaHareketService>();
builder.Services.AddScoped<IBankaHareketService, BankaHareketService>();
builder.Services.AddScoped<ITahsilatOdemeBelgesiService, TahsilatOdemeBelgesiService>();
builder.Services.AddScoped<ITasinirKodService, TasinirKodService>();
builder.Services.AddScoped<ITasinirKartService, TasinirKartService>();
