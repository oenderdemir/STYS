...
public class RezervasyonGelirTahakkukuTests
{
    ...
    private sealed class FakeMuhasebeFisService : IMuhasebeFisService
    {
        ...
        public Task<STYS.Muhasebe.MuhasebeFisleri.Dtos.MuhasebeFisIptalSonucDto> PosValorTransferFisiniGeriAlAsync(int tersKayitFisId, int beklenenKaynakId, int beklenenTesisId, string aciklama, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<STYS.Muhasebe.MuhasebeFisleri.Dtos.MuhasebeFisIptalSonucDto> SatisBelgesiFisiIptalEtAsync(int muhasebeFisId, int beklenenKaynakId, int beklenenTesisId, string aciklama, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<STYS.Muhasebe.MuhasebeFisleri.Dtos.MuhasebeFisIptalSonucDto> KantinSatisFisiIptalEtAsync(int muhasebeFisId, int beklenenKaynakId, int beklenenTesisId, string aciklama, CancellationToken cancellationToken = default) => throw new NotSupportedException();
