...
/// <summary>
/// Kamp rezervasyonu üzerinden satış belgesi taslağı oluşturma request modeli.
/// Controller route'undaki {rezervasyonId} ile RezervasyonId eşleşmelidir.
/// </summary>
public class KampSatisBelgesiTaslakRequest
{
    /// <summary>
    /// Satış belgesi oluşturulacak kamp rezervasyonunun Id'si.
    ...
    /// <summary>Belge tarihi. Boşsa bugünün tarihi kullanılır.</summary>
    ...
    /// <summary>KDV istisna tanım Id'si. Verilirse satır bu istisna ile oluşturulur.</summary>
