# Turgut Özcan Dönemi Revert Analizi

## Amaç
Bu çalışma, ilgili dönemde Turgut Özcan commitleriyle bozulan veya geri dönen Önder Demir çalışmalarını güvenli şekilde geri almak için hazırlanmıştır.
...
## Korunan Commitler
Önder Demir commitleri korunmuştur.
...
| Commit | Author | Mesaj | Revert yöntemi | Not |
|---|---|---|---|---|
| `8f4b6b8a4d30f2e509063e0e11196c60cc2e10fd` | Turgut Ozcan | `Merge branch 'main' of https://github.com/oenderdemir/STYS` | `git revert -m 2` | Önder tarafı parent olarak korundu. Merge çatışmaları Önder versiyonu tercih edilerek çözüldü. |
| `6c110f2dcbc67c9abb912e2af86f2558c4fdfe3f` | Turgut Ozcan | `merge ui` | `8f4b6b8 revert'i ile tree seviyesinde kapsandı` | Ayrı revert uygulanmadı; üst merge revert Turgut UI zincirini zaten nötralize etti. |
| `6d3114d248b647b0076b1db280ffe979732ccc8a` | Turgut Ozcan | `arayüz` | `8f4b6b8 revert'i ile tree seviyesinde kapsandı` | Ayrı revert uygulanmadı; üst merge revert ile etkisi geri alındı. |
...
- Tüm çatışmalarda Önder Demir tarafı korundu.
...
## Sonuç
- Turgut Özcan tarafındaki merge/UI etkileri güvenli şekilde nötralize edildi.
- Önder Demir tarafındaki muhasebe, cari kart ve datepicker çalışmaları korundu.
