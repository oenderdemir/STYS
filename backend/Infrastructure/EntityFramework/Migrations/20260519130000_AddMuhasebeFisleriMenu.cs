...
[Migration("20260519130000_AddMuhasebeFisleriMenu")]
public partial class AddMuhasebeFisleriMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            BEGIN
                ...
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@MenuItemId, N'Muhasebe Fişleri', N'pi pi-list', N'muhasebe/fisler', @MuhasebeRootId, 14, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'Muhasebe Fişleri',
                    [Icon] = N'pi pi-list',
            ...
            -- MenuItemRoles: Muhasebe root ve Muhasebe Fisleri icin Menu rolu atamasi
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            """
            -- Sadece Muhasebe Fisleri MenuItem ve MenuItemRoles kayitlarini temizle.
            ...
            WHERE mi.[Route] = N'muhasebe/fisler';

            DELETE FROM [TODBase].[MenuItems]
            WHERE [Route] = N'muhasebe/fisler';
            """);
    }
}
