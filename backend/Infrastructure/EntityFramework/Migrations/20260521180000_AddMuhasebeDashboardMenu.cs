...
[Migration("20260521180000_AddMuhasebeDashboardMenu")]
public partial class AddMuhasebeDashboardMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            BEGIN
                ...
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@MenuItemId, N'Muhasebe Özet', N'pi pi-chart-line', N'muhasebe/dashboard', @MuhasebeRootId, 1, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'Muhasebe Özet',
                    [Icon] = N'pi pi-chart-line',
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            WHERE mi.[Route] = N'muhasebe/dashboard';

            DELETE FROM [TODBase].[MenuItems]
            WHERE [Route] = N'muhasebe/dashboard';
            """);
    }
}
