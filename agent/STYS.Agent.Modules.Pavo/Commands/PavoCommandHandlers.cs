...
public sealed class PavoStartPaymentCommandHandler : IAgentCommandHandler<PavoStartPaymentCommand>
{
    ...
    private static PavoStartPaymentRequest ToRequest(PavoStartPaymentCommand command) => new()
    {
        ...
        MinInstallmentCount = command.MinInstallmentCount,
        MaxInstallmentCount = command.MaxInstallmentCount,
        IsPfInstallmentEnabled = command.IsPfInstallmentEnabled,
        Puan = command.Puan,
        SelectedSlots = command.SelectedSlots,
        CardReadTimeout = command.CardReadTimeout,
        AllowDismissCardRead = command.AllowDismissCardRead,
        PinEntryTimeout = command.PinEntryTimeout,
        SelectedTerminals = command.SelectedTerminals,
        CustomApp = command.CustomApp,
        CustomLogin = command.CustomLogin,
        CustomCommission = command.CustomCommission,
        // Receipt policy is propagated explicitly from the command (set by the backend) so the agent
        // never relies on coincidentally-matching domain defaults.
        PrintReceipt = command.PrintReceipt,
        ResponseBeforePrintEnabled = command.ResponseBeforePrintEnabled,
        CustomerReceiptPrintEnabled = command.CustomerReceiptPrintEnabled,
        MerchantReceiptPrintEnabled = command.MerchantReceiptPrintEnabled,
        ReceiptImage = command.ReceiptImage,
        CustomerReceiptImageEnabled = command.CustomerReceiptImageEnabled,
        MerchantReceiptImageEnabled = command.MerchantReceiptImageEnabled,
        ReceiptWidth = command.ReceiptWidth,
        HeadUnmaskLength = command.HeadUnmaskLength,
        TailUnmaskLength = command.TailUnmaskLength,
        ReceiptHeader = command.ReceiptHeader,
        ReceiptFooter = command.ReceiptFooter,
        ReceiptJsonEnabled = command.ReceiptJsonEnabled,
        CustomerReceiptJsonEnabled = command.CustomerReceiptJsonEnabled,
        MerchantReceiptJsonEnabled = command.MerchantReceiptJsonEnabled,
        ReceiptTextEnabled = command.ReceiptTextEnabled,
        ReceiptTextWidth = command.ReceiptTextWidth,
        CustomerReceiptTextEnabled = command.CustomerReceiptTextEnabled,
        CustomerReceiptTextWidth = command.CustomerReceiptTextWidth,
        MerchantReceiptTextEnabled = command.MerchantReceiptTextEnabled,
        MerchantReceiptTextWidth = command.MerchantReceiptTextWidth,
        TransactionHandle = command.TransactionHandle
    };
}
