...
import { OdaOzellikDto, ODA_OZELLIK_VERI_TIPI_OPTIONS } from './oda-ozellik-yonetimi.dto';
...
export class OdaOzellikDialog implements OnChanges {
    @Input() visible = false;
    @Input() mode: CrudDialogMode = 'create';
    @Input() model: OdaOzellikDto = { kod: '', ad: '', veriTipi: 'boolean', aktifMi: true };
    @Input() saving = false;
    @Input() canManage = false;

    @Output() readonly visibleChange = new EventEmitter<boolean>();
    @Output() readonly save = new EventEmitter<OdaOzellikDto>();
    @Output() readonly modeChange = new EventEmitter<CrudDialogMode>();

    readonly veriTipiOptions = ODA_OZELLIK_VERI_TIPI_OPTIONS;
    workingModel: OdaOzellikDto = { kod: '', ad: '', veriTipi: 'boolean', aktifMi: true };
    ...
    get dialogTitle(): string {
        if (this.mode === 'create') {
            return 'Yeni Oda Ozellik';
        }

        if (this.mode === 'edit') {
            return 'Oda Ozellik Duzenle';
        }

        return 'Oda Ozellik Detay';
    }
    ...
    submit(): void {
        ...
        this.save.emit({
            ...
            veriTipi: this.workingModel.veriTipi,
