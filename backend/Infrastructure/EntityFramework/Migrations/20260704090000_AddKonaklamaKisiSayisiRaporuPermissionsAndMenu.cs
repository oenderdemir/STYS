...
[Migration("20260704090000_AddKonaklamaKisiSayisiRaporuPermissionsAndMenu")]
public partial class AddKonaklamaKisiSayisiRaporuPermissionsAndMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            -- Permission rolleri: KonaklamaKisiSayisiRaporuYonetimi.Menu ve .View
            ...
            INSERT INTO @RequiredRoles ([Domain], [Name]) VALUES
                (N'KonaklamaKisiSayisiRaporuYonetimi', N'Menu'),
                (N'KonaklamaKisiSayisiRaporuYonetimi', N'View');
            ...
            DECLARE @MenuRoleId uniqueidentifier = (
                ...
                WHERE [Domain] = N'KonaklamaKisiSayisiRaporuYonetimi' AND [Name] = N'Menu'
            );
            DECLARE @ViewRoleId uniqueidentifier = (
                SELECT TOP (1) [Id] FROM [TODBase].[Roles]
                WHERE [Domain] = N'KonaklamaKisiSayisiRaporuYonetimi' AND [Name] = N'View'
            );
            ...
            -- Grup menü item'a KonaklamaKisiSayisiRaporuYonetimi.Menu rolünü bağla (görünürlük için)
            IF NOT EXISTS (
            ...
            -- Aylik Konaklayan Kisi Sayisi menu item
            DECLARE @KonaklamaKisiSayisiMenuItemId uniqueidentifier;
            SELECT TOP (1) @KonaklamaKisiSayisiMenuItemId = [Id]
            FROM [TODBase].[MenuItems]
            WHERE [Route] = N'raporlar/konaklama-kisi-sayisi' AND [IsDeleted] = 0;

            IF @KonaklamaKisiSayisiMenuItemId IS NULL
            BEGIN
                SET @KonaklamaKisiSayisiMenuItemId = NEWID();
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [QueryParams], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@KonaklamaKisiSayisiMenuItemId, N'Aylik Konaklayan Kisi Sayisi', N'pi pi-users', N'raporlar/konaklama-kisi-sayisi', NULL, @RaporlarMenuGrupId, 2, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'Aylik Konaklayan Kisi Sayisi',
                    [Icon] = N'pi pi-users',
                    ...
                    [DeletedAt] = NULL,
                    [UpdatedAt] = @Now
                WHERE [Id] = @KonaklamaKisiSayisiMenuItemId;
            END;

            -- Menü görünürlük rolü: KonaklamaKisiSayisiRaporuYonetimi.Menu
            IF NOT EXISTS (
                SELECT 1 FROM [TODBase].[MenuItemRoles]
                WHERE [MenuItemId] = @KonaklamaKisiSayisiMenuItemId AND [RoleId] = @MenuRoleId AND [IsDeleted] = 0
            )
                INSERT INTO [TODBase].[MenuItemRoles] ([Id], [MenuItemId], [RoleId], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (NEWID(), @KonaklamaKisiSayisiMenuItemId, @MenuRoleId, 0, @Now, @Now);
            """);
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            SET [IsDeleted] = 1, [UpdatedAt] = SYSUTCDATETIME()
            WHERE [Domain] = N'KonaklamaKisiSayisiRaporuYonetimi' AND [IsDeleted] = 0;
            """);
    }
}
