...
[Migration("20260523000000_AddKdvHareketRaporuMenu")]
public partial class AddKdvHareketRaporuMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            BEGIN
                ...
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@MenuItemId, N'KDV Hareket Raporu', N'pi pi-chart-bar', N'muhasebe/kdv-hareket-raporu', @MuhasebeRootId, 9, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'KDV Hareket Raporu',
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            WHERE mi.[Route] = N'muhasebe/kdv-hareket-raporu';

            DELETE FROM [TODBase].[MenuItems]
            WHERE [Route] = N'muhasebe/kdv-hareket-raporu';
            """);
    }
}
