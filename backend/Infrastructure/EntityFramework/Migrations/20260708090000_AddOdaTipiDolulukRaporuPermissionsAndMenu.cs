...
[Migration("20260708090000_AddOdaTipiDolulukRaporuPermissionsAndMenu")]
public partial class AddOdaTipiDolulukRaporuPermissionsAndMenu : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            -- Permission rolleri: OdaTipiDolulukRaporuYonetimi.Menu ve .View
            ...
            INSERT INTO @RequiredRoles ([Domain], [Name]) VALUES
                (N'OdaTipiDolulukRaporuYonetimi', N'Menu'),
                (N'OdaTipiDolulukRaporuYonetimi', N'View');
            ...
            DECLARE @MenuRoleId uniqueidentifier = (
                ...
                WHERE [Domain] = N'OdaTipiDolulukRaporuYonetimi' AND [Name] = N'Menu'
            );
            DECLARE @ViewRoleId uniqueidentifier = (
                SELECT TOP (1) [Id] FROM [TODBase].[Roles]
                WHERE [Domain] = N'OdaTipiDolulukRaporuYonetimi' AND [Name] = N'View'
            );
            ...
            -- Grup menü item'a OdaTipiDolulukRaporuYonetimi.Menu rolünü bağla (görünürlük için)
            IF NOT EXISTS (
            ...
            -- Oda Tipi Bazli Doluluk Raporu menu item
            DECLARE @OdaTipiDolulukMenuItemId uniqueidentifier;
            SELECT TOP (1) @OdaTipiDolulukMenuItemId = [Id]
            FROM [TODBase].[MenuItems]
            WHERE [Route] = N'raporlar/oda-tipi-doluluk' AND [IsDeleted] = 0;

            IF @OdaTipiDolulukMenuItemId IS NULL
            BEGIN
                SET @OdaTipiDolulukMenuItemId = NEWID();
                INSERT INTO [TODBase].[MenuItems] ([Id], [Label], [Icon], [Route], [QueryParams], [ParentId], [MenuOrder], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (@OdaTipiDolulukMenuItemId, N'Oda Tipi Bazli Doluluk Raporu', N'pi pi-chart-bar', N'raporlar/oda-tipi-doluluk', NULL, @RaporlarMenuGrupId, 6, 0, @Now, @Now);
            END
            ELSE
            BEGIN
                UPDATE [TODBase].[MenuItems]
                SET [Label] = N'Oda Tipi Bazli Doluluk Raporu',
                    ...
                    [DeletedAt] = NULL,
                    [UpdatedAt] = @Now
                WHERE [Id] = @OdaTipiDolulukMenuItemId;
            END;

            -- Menü görünürlük rolü: OdaTipiDolulukRaporuYonetimi.Menu
            IF NOT EXISTS (
                SELECT 1 FROM [TODBase].[MenuItemRoles]
                WHERE [MenuItemId] = @OdaTipiDolulukMenuItemId AND [RoleId] = @MenuRoleId AND [IsDeleted] = 0
            )
                INSERT INTO [TODBase].[MenuItemRoles] ([Id], [MenuItemId], [RoleId], [IsDeleted], [CreatedAt], [UpdatedAt])
                VALUES (NEWID(), @OdaTipiDolulukMenuItemId, @MenuRoleId, 0, @Now, @Now);
            """);
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            SET [IsDeleted] = 1, [UpdatedAt] = SYSUTCDATETIME()
            WHERE [Domain] = N'OdaTipiDolulukRaporuYonetimi' AND [IsDeleted] = 0;
            """);
    }
}
