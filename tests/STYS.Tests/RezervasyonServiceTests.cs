...
public class RezervasyonServiceTests
{
    ...
    public async Task UzatmaSecenekleri_SonucSiralamasiVeKodlariDeterministiktir()
    {
        ...
        Assert.Equal("UZATMA-1", sonuc1.Secenekler[0].SenaryoKodu);
    ...
    [Fact]
    public async Task UzatmaSecenekleri_OdaBolunmesi_101IkiKisidenBirBirKisiye_SifirOdaDegisimiSayilmaz()
    {
        await using var dbContext = CreateDbContext();
        ...
        Assert.NotEqual(0, secim.OdaDegisimSayisi);
